<template>
    <div class="home" id="homeScroll" name="scroll">
        ...
        <div class="hero">
            ...
            <p class="hero-role">
                I'm a <span class="hero-role-typed">{{ displayedRole }}<span class="hero-cursor">|</span></span>
            </p>

            <p class="hero-desc">
                Passionate about full-stack development, cyber security, and server management.
                I build business-critical systems and solve complex technical challenges.
            </p>
            ...
            <div class="hero-ctas">
                ...
                <button class="cta-secondary" @click="scrollToContact">Get In Touch</button>
            </div>

            <div class="hero-socials">
                <a href="https://github.com/samlkey" target="_blank" rel="noopener" aria-label="GitHub profile">
                ...
                <a href="https://www.linkedin.com/in/samkey726/" target="_blank" rel="noopener" aria-label="LinkedIn profile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export default {
    ...
    data() {
        return {
            roles: ['Software Developer', 'Full-Stack Engineer', 'Security Enthusiast', 'Problem Solver'],
            roleIndex: 0,
            displayedRole: '',
            isTyping: true,
        }
    ...
    methods: {
        ...
        scrollToContact() {
            window.dispatchEvent(new CustomEvent('portfolio-navigate', { detail: { index: 4 } }));
        }
    }
}
</script>
